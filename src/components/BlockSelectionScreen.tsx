...
export function BlockSelectionScreen({ onStart, onBack }: BlockSelectionScreenProps) {
    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-b from-blue-50 to-white">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle style={{ fontSize: '1.25rem', fontWeight: 'bold' }}>Sélection de bloc</CardTitle>
          <CardDescription className="text-lg">
            Choisissez un bloc spécifique ou aléatoire
          </CardDescription>
        </CardHeader>
