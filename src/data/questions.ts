...
export const questions: Question[] = [
  {
    ...
    "question2": "[Réglage de la hauteur des feux] Pourquoi doit-on régler la hauteur des feux ?",
  ...
  },
  {
    ...
    "question2": "[Liquide lave-glace] Pourquoi est-il préférable d'utiliser un liquide spécial en hiver ?",
  ...
  },
  {
    ...
    "question2": "[Rétroviseur intérieur position 'nuit'] Quel est l'intérêt de la position nuit ?",
  ...
  },
  {
    ...
    "question2": "[Pneumatiques] Citez un endroit où l'on peut trouver les pressions préconisées pour les pneumatiques ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat actionne la commande.",
    "question2": "[Essuie-glaces] Comment détecter leur usure en circulation ?",
  ...
  },
  {
    ...
    "question2": "[Plaques d'immatriculation] Quelles sont les précautions à prendre en cas d'installation d'un porte vélo ?",
  ...
  },
  {
    ...
    "question2": "[Gilet de haute visibilité] En cas de panne ou d'accident, quel autre accessoire de sécurité est obligatoire ?",
  ...
  },
  {
    ...
    "question2": "[Liquide de frein] Quelle est la conséquence d'un niveau insuffisant du liquide de frein ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat doit présenter le document. La photocopie est acceptée.",
    "question2": "[Certificat d'immatriculation] Quels sont les deux autres documents obligatoires à présenter en cas de contrôle par les forces de l'ordre ?",
  ...
  },
  {
    ...
    "answer1": "Vérification des balais avant et arrière s'il y a lieu, en bon état (toute anomalie doit être signalée).",
    "question2": "[Balais d'essuie-glace] Quel est le risque de circuler avec des balais d'essuie glace défectueux ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre le voyant sur le tableau de bord.",
    "question2": "[Niveau de carburant] Quelles sont les précautions à prendre lors du remplissage du réservoir ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat ouvre le capot et montre le bocal. Si le candidat a des difficultés pour ouvrir le capot, l'accompagnateur peut lui indiquer comment procéder.",
    "question2": "[Liquide de refroidissement] Quel est le danger si l'on complète le niveau du liquide lorsque le moteur est chaud ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat actionne la commande et montre le voyant allumé.",
    "question2": "[Dégivrage de la lunette arrière] Quelle peut être la conséquence d'une panne de dégivrage de la lunette arrière ?",
  ...
  },
  {
    ...
    "answer1": "L'accompagnateur actionne les clignotants. Vérification des clignotants propres, en bon état et fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Clignotants] Quelle est la signification d'un clignotement plus rapide ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre le voyant d'alerte sur le tableau de bord (couleur rouge, symbole de la burette d'huile).",
    "question2": "[Voyant de pression d'huile] Quelles sont les conditions à respecter pour contrôler le niveau d'huile ?",
  ...
  },
  {
    ...
    "answer1": "L'accompagnateur actionne le(s) feu(x). Vérification des feux, propres, en bon état et fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Feux de brouillard arrière] Dans quels cas les utilise-t-on ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat doit indiquer où il se trouve sans obligation de le sortir.",
    "question2": "[Éthylotest / Alcoolémie] A partir de quel taux d'alcoolémie, en période de permis probatoire, est-on en infraction ?",
  ...
  },
  {
    ...
    "answer1": "L'accompagnateur actionne les feux. Vérification des feux, propres, en bon état et fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Feux de détresse] Dans quels cas doit-on les utiliser ?",
  ...
  },
  {
    ...
    "question2": "[Réglage du volant] Pourquoi est-il important de bien régler son volant ? Citez deux exemples.",
  ...
  },
  {
    ...
    "answer1": "L'accompagnateur actionne les feux. Vérification des feux, propres, en bon état et fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Feux de route] Citez un cas d'utilisation de l'appel lumineux.",
  ...
  },
  {
    ...
    "answer1": "Le candidat actionne la commande. La position auto (désembuage automatique) peut être utilisée si le véhicule en est équipé.",
    "question2": "[Ventilation / Désembuage] Citez deux éléments complémentaires permettant un désembuage efficace.",
  ...
  },
  {
    ...
    "question2": "[Niveau d'huile moteur] Quel est le principal risque d'un manque d'huile moteur ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre le voyant d'alerte sur le tableau de bord (couleur rouge, symbole de la batterie).",
    "question2": "[Voyant de batterie] Qu'est-ce qui peut provoquer la décharge de la batterie, moteur éteint ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre l'emplacement de la batterie (souvent sous le capot ou dans le coffre). Si le candidat a des difficultés pour ouvrir le capot, l'accompagnateur peut lui indiquer comment procéder.",
    "question2": "[Batterie] Quelle est la solution en cas de panne de batterie pour démarrer le véhicule sans le déplacer ?",
  ...
  },
  {
    ...
    "answer1": "Rouge (symbole du cercle avec un '!' ou la lettre 'P' au milieu et des parenthèses autour).",
    "question2": "[Voyant de freinage] Quel est le risque de circuler avec un frein de parking mal desserré ?",
  ...
  },
  {
    ...
    "answer1": "L'accompagnateur actionne les feux. Vérification des feux, propres, en bon état et fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Feux de croisement] Quelles sont les conséquences d'un mauvais réglage de ces feux ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre le voyant d'alerte sur le tableau de bord (couleur rouge, symbole du thermomètre dans l'eau).",
    "question2": "[Voyant de température du liquide de refroidissement] Quelle est la conséquence d'une température trop élevée de ce liquide ?",
  ...
  },
  {
    ...
    "question2": "[Dispositifs réfléchissants] Quelle est l'utilité des dispositifs réfléchissants ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre le voyant (couleur rouge ou orange, symbole d'une voiture avec une porte ouverte).",
    "question2": "[Voyant de portière ouverte] Quelle précaution dois-je prendre pour que les enfants installés à l'arrière ne puissent pas ouvrir leur portière ?",
  ...
  },
  {
    ...
    "answer1": "L'accompagnateur actionne les feux. Vérification des feux, propres, en bon état et fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Feux de position] Par temps clair, à quelle distance doivent-ils être visibles ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat actionne la commande.",
    "question2": "[Feux de détresse] Quand les utilise-t-on ?",
    "answer2": "En cas de panne, d'accident ou de ralentissement important.",
    "question3": "Quels comportements adopter en cas de diffusion du signal d'alerte du Système d'Alerte et d'Information des Populations (SAIP) ?",
    "answer3": "- Se mettre en sécurité. - S'informer grâce aux médias et sites internet des autorités dès que leur consultation est possible. - Respecter les consignes des autorités."
  },
  {
    ...
    "answer1": "Le candidat montre le témoin d'usure (petite bosse au fond des rainures principales).",
    "question2": "[Pneumatiques] Qu'est-ce que l'aquaplanage, et quelle peut être sa conséquence ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre la commande (généralement sur ou près du volant, ou sur un commodo).",
    "question2": "[Régulateur de vitesse] Sans actionner la commande du régulateur, comment le désactiver rapidement ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat ouvre la trappe et/ou vérifie le bon vissage/clipsage du bouchon.",
    "question2": "[Trappe / Bouchon de carburant] Quelles sont les précautions à prendre lors du remplissage du réservoir ?",
    "answer2": "Arrêter le moteur, ne pas fumer, ne pas téléphoner.",
    "question3": "Pourquoi l'alerte auprès des services de secours doit-elle être rapide et précise ?",
    "answer3": "Pour permettre aux services de secours d'apporter les moyens adaptés aux victimes dans le délai le plus court."
  },
  {
    ...
    "answer1": "Le candidat montre l'emplacement (généralement au centre du volant).",
    "question2": "[Avertisseur sonore] Dans quel cas peut-on utiliser l'avertisseur sonore en agglomération ?",
  ...
  },
  {
    ...
    "question2": "[Remplissage d'huile moteur] Quel est le risque d'un manque d'huile moteur ?",
    "answer2": "Un risque de détérioration ou de casse du moteur.",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre la commande (généralement sur le tableau de bord ou à l'extrémité du tableau de bord, côté passager).",
    "question2": "[Airbag passager] Dans quelle situation doit-on le désactiver ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre la plaque (située sur une portière ou dans la trappe à carburant) et donne l'information requise (valeur en bar).",
    "question2": "[Pression des pneus] A quelle fréquence est-il préconisé de vérifier la pression des pneus ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre le voyant (couleur rouge, symbole du passager avec ceinture non bouclée).",
    "question2": "[Voyant de ceinture] En règle générale, à partir de quel âge un enfant peut-il être installé sur le siège passager avant du véhicule ?",
    "answer2": "10 ans.",
    "question3": "Comment est composé le signal d'alerte du Système d'Alerte et d'Information des Populations (SAIP) diffusé par les sirènes ?",
    "answer3": "Il se compose de deux codes distincts : - Le Signal National d'Alerte (SNA), variation du signal sur trois cycles successifs. - Le signal de fin d'alerte, signal continu."
  },
  {
    ...
    "answer1": "L'accompagnateur allume les feux de position. Le candidat vérifie le fonctionnement de l'éclairage de la plaque (toute anomalie doit être signalée).",
    "question2": "[Éclairage de la plaque d'immatriculation] Un défaut d'éclairage de la plaque lors du contrôle technique entraîne-t-il une contre-visite ?",
    "answer2": "Oui.",
    "question3": "Quelles sont les trois informations à transmettre aux services de secours ?",
    "answer3": "Le numéro de téléphone à partir duquel l'appel est émis, la nature et la localisation la plus précise du problème."
  },
  {
    ...
    "answer1": "Le candidat présente le document et montre la vignette sur le pare-brise.",
    "question2": "[Assurance / Vignette] Quels sont les deux autres documents obligatoires à présenter en cas de contrôle par les forces de l'ordre ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat se rend à une portière arrière et montre l'emplacement (généralement un petit levier sur le chant de la portière).",
    "question2": "[Sécurité enfant] Si la sécurité enfant est enclenchée, est-il possible d'ouvrir la portière arrière depuis l'extérieur ?",
    "answer2": "Oui.",
  ...
  },
  {
    ...
    "answer1": "Le candidat actionne la commande et montre le voyant allumé (couleur orange, symbole avec 3 traits horizontaux barrés par une vague).",
    "question2": "[Feux de brouillard arrière] Pouvez-vous les utiliser par forte pluie ?",
    "answer2": "Non.",
  ...
  },
  {
    ...
    "answer1": "L'accompagnateur engage la marche arrière. Vérification des feux, propres, en bon état et qui fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Feux de recul] Quelles sont leurs deux utilités ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre le système de réglage.",
    "question2": "[Appui-tête] Quelle est son utilité ?",
  ...
  },
  {
    ...
    "answer1": "L'accompagnateur appuie sur la pédale de frein. Vérification des feux, propres, en bon état et fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Feux de stop] Quelle est la conséquence en cas de panne des feux de stop ?",
  ...
  },
  {
    ...
    "answer1": "Orange (symbole avec 3 traits horizontaux barrés par une vague).",
    "question2": "[Voyant] Quelle est la différence entre un voyant orange et un voyant rouge ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat ouvre le capot, le referme, et vérifie qu'il est bien verrouillé.",
    "question2": "[Capot] En roulant, quel est le risque d'une mauvaise fermeture du capot ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre la commande (symbole d'une voiture avec une flèche en boucle à l'intérieur).",
    "question2": "[Recyclage de l'air] Quel peut être le risque de maintenir le recyclage de l'air de manière prolongée ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat ouvre le capot et montre l'orifice de remplissage (généralement avec un bouchon bleu). Si le candidat a des difficultés pour ouvrir le capot, l'accompagnateur peut lui indiquer comment procéder.",
    "question2": "[Orifice de remplissage lave-glace] Quel est le principal risque d'une absence de liquide lave-glace ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat actionne la commande et montre le voyant allumé (couleur bleue, symbole d'un phare avec des traits droits).",
    "question2": "[Feux de route] Quel est le risque de maintenir les feux de route lors d'un croisement avec d'autres usagers ?",
  ...
  },
  {
    ...
    "answer1": "L'accompagnateur met le contact. Vérification des feux, propres, en bon état et qui fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Feux diurnes] Quelle est leur utilité ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat doit présenter le document (souvent dans la boîte à gants).",
    "question2": "[Constat amiable] En cas d'accident, dans quel délai doit-il être transmis à l'assureur ?",
    "answer2": "5 jours.",
    "question3": "Quel est le risque principal d'un arrêt cardiaque sans intervention des secours ?",
    "answer3": "La mort de la victime qui survient en quelques minutes."
  },
  {
    ...
    "answer1": "Le candidat doit indiquer où il se trouve (souvent dans le coffre) sans obligation de le sortir.",
    "question2": "[Triangle de pré-signalisation] Utilise-t-on le triangle de pré-signalisation sur autoroute ?",
    "answer2": "Non.",
    "question3": "Quel comportement doit-on adopter en présence d'une victime en arrêt cardiaque ?",
    "answer3": "- ALERTER: alerter immédiatement les secours. - MASSER: pratiquer une réanimation cardio-pulmonaire. - DEFIBRILLER: utiliser un défibrillateur automatique (DAE) si possible."
  },
  ...
  },
  {
    ...
    "answer1": "Le candidat ouvre le capot et montre l'emplacement du phare (par exemple la trappe d'accès ou l'arrière du bloc-optique). Si le candidat a des difficultés pour ouvrir le capot, l'accompagnateur peut lui indiquer comment procéder.",
    "question2": "[Changement d'ampoule avant] Quelles sont les conséquences en cas de panne d'un feu de croisement ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre la commande (généralement sur ou près du volant, ou sur un commodo).",
    "question2": "[Limiteur de vitesse] Quelle est l'utilité d'un limiteur de vitesse ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre l'emplacement du feu arrière (par exemple l'accès depuis le coffre ou l'extérieur du bloc-optique).",
    "question2": "[Changement d'ampoule arrière] Quelles sont les conséquences en cas de panne d'un feu de position arrière ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat actionne la commande.",
    "question2": "[Essuie-glace arrière] Pour une bonne visibilité vers l'arrière, en plus de l'utilisation de l'essuie-glace, quelle commande pouvez-vous actionner par temps de pluie ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat ouvre le coffre, le referme, et vérifie qu'il est bien verrouillé.",
    "question2": "[Coffre] Lorsque vous transportez un poids important dans le coffre, quelles sont les précautions à prendre en ce qui concerne les pneumatiques et l'éclairage avant ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre l'emplacement des attaches (souvent aux places arrière). Pour info : les attaches de type Isofix sont obligatoires sur les véhicules neufs depuis 2011.",
    "question2": "[Attaches Isofix] Peut-on fixer tous les sièges enfant sur des attaches de type Isofix ?",
  ...
  },
  {
    ...
    "question1": "Ouvrez et refermez le coffre, puis vérifiez sa bonne fermeture.",
    "answer1": "Le candidat ouvre le coffre, le referme, et vérifie qu'il est bien verrouillé.",
    "question2": "[Coffre] Quels sont les risques de circuler avec des objets sur la plage arrière ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre le voyant (couleur orange ou jaune, symbole en forme de fer à cheval avec un point d'exclamation au centre). Pour info: obligatoire sur tous les véhicules neufs mis en circulation à compter du 01/11/2014.",
    "question2": "[Voyant de pression des pneus] A quelle fréquence est-il préconisé de vérifier la pression d'air des pneumatiques ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat ouvre le capot, vérifie le dispositif de sécurité, le referme, et vérifie qu'il est bien verrouillé.",
    "question2": "[Capot] Pour un capot s'ouvrant depuis l'avant du véhicule, quelle est l'utilité du dispositif de sécurité ?",
  ...
  },
  {
    ...
    "answer1": "Le candidat montre les gicleurs sur le capot ou à la base du pare-brise.",
    "question2": "[Gicleurs de lave-glace] Quelle est la principale conséquence d'un dispositif de lave-glace défaillant ?",
  ...
  },
  {
    ...
    "question1": "Faites fonctionner les essuie-glaces avants du véhicule sur la position la plus rapide.",
    "answer1": "Le candidat actionne la commande.",
    "question2": "[Essuie-glaces] Comment détecte-t-on leur usure en circulation ?",
    "answer2": "En cas de pluie, lorsqu'ils laissent des traces sur le pare brise.",
    "question3": "Comment vérifier la respiration d'une victime ?",
    "answer3": "Regarder si le ventre et la poitrine se soulèvent et sentir de l'air à l'expiration."
  },
  ...
  },
  {
    ...
    "question1": "Montrez le voyant d'alerte signalant une pression insuffisante d'huile dans le moteur.",
    "answer1": "Le candidat montre le voyant d'alerte sur le tableau de bord (couleur rouge, symbole de la burette d'huile).",
    "question2": "[Voyant de pression d'huile] Quelles sont les conditions à respecter pour compléter le niveau d'huile ?",
    "answer2": "Moteur froid et sur un terrain plat.",
    "question3": "Quelles sont les trois informations à transmettre aux services de secours ?",
    "answer3": "Le numéro de téléphone à partir duquel l'appel est émis, la nature et la localisation la plus précise du problème."
  },
  ...
  },
  {
    ...
    "question1": "Contrôlez l'état, la propreté et le fonctionnement des feux de route.",
    "answer1": "L'accompagnateur actionne les feux. Vérification des feux, propres, en bon état et fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Feux de route] Citez un cas d'utilisation d'un appel lumineux.",
    "answer2": "- Pour avertir de son approche. - En cas de danger. - A la place de l'avertisseur sonore.",
    "question3": "En cas de panne ou d'accident, quel équipement de sécurité doit être porté avant de quitter le véhicule ?",
    "answer3": "Il faut porter le gilet de haute visibilité avant de sortir du véhicule. Le terme \"gilet jaune\" peut être utilisé par le candidat."
  },
  ...
  },
  {
    ...
    "type": "VE",
    "question1": "Vérifiez l'état, la propreté et le fonctionnement des feux diurnes.",
    "answer1": "L'accompagnateur met le contact. Vérification des feux, propres, en bon état et fonctionnent (toute anomalie doit être signalée).",
    "question2": "[Feux diurnes] Quelle est leur utilité ?",
    "answer2": "Rendre le véhicule plus visible le jour.",
    "question3": "A quel moment pouvez-vous mettre fin à un appel avec les secours ?",
    "answer3": "Uniquement lorsque notre correspondant nous invite à le faire."
